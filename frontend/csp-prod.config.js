...
const productionCSP = {
  ...
  headers: {
    ...
    'Content-Security-Policy': [
      ...
      "connect-src 'self' https://your-api-domain.com https://fonts.googleapis.com https://images.pexels.com https://images.unsplash.com",  // Replace with your actual API domains
...
const strictProductionCSP = {
  headers: {
    'Content-Security-Policy': [
      ...
      "img-src 'self' data: https: blob:",
      "font-src 'self' https: data:",
      "connect-src 'self' https://your-api-domain.com https://fonts.googleapis.com https://images.pexels.com https://images.unsplash.com",
      "frame-ancestors 'none'",
      "object-src 'none'",
      "base-uri 'self'",
      "form-action 'self'",
